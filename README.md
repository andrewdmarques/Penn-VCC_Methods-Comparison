...
- Some of the samples are confirmed to be decontaminated (Moustafa Lab processed samples), while others (SRA downloaded samples from Guanxiang et al.) may have had and samples from 
