...
- Some of the samples are confirmed to be decontaminated (Moustafa Lab processed samples), while others (SRA downloaded samples from Guanxiang et al.) may have had and samples decontaminated with host reads removed by an older version of sunbeam, and other samples like library particle enrichment do not have any host read decontamination yet. 
